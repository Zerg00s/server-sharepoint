 ...
 * @param params Parameters including site URL, content type ID, and update data
 * @param config SharePoint configuration
 * @returns Tool result with updated content type information
 */
export async function updateSiteContentType(
    params: UpdateSiteContentTypeParams, 
    config: SharePointConfig
): Promise<IToolResult> {
    const { url, contentTypeId, updateData } = params;
    console.error("updateSiteContentType tool called with URL:", url, "contentTypeId:", contentTypeId);
    ...
    try {
        ...
        console.error("Making request to update site content type:", JSON.stringify(updateBody));
        ...
        try {
            ...
            console.error("Site content type updated successfully");
            ...
            return {
                content: [{
                    ...
                    text: JSON.stringify({
                        success: true,
                        message: `Site content type with ID '${contentTypeId}' updated successfully.`,
                        contentType: {
            ...
            try {
                ...
                console.error("Site content type updated successfully via alternative method");
                ...
                return {
                    content: [{
                        ...
                        text: JSON.stringify({
                            success: true,
                            message: `Site content type with ID '${contentTypeId}' updated successfully via alternative method.`,
                ...
                console.error("Error in updateSiteContentType tool:", errorMessage);
                
                return {
                    content: [{
                        type: "text",
                        text: `Error updating site content type: ${errorMessage}`
                    }],
                    isError: true
                } as IToolResult;
            }
...
export default updateSiteContentType;
